...
function SidenavDirective($mdMedia, $mdUtil, $mdConstant, $mdTheming, $animate, $compile, $parse, $log, $q, $document) {
  ...
  function postLink(scope, element, attr, sidenavCtrl) {
    ...
    /* Custom backdrop */
    var backdropClass = "md-sidenav-backdrop md-opaque ng-enter";
    if (attr.backBackdrop == "transparent") {
      backdropClass = "md-sidenav-backdrop ng-enter";
    }

    var backdrop = $mdUtil.createBackdrop(scope, backdropClass);
